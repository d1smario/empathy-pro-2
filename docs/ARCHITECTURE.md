...
**Contesto trasversale e arricchimento nel tempo** (hub vs moduli dominio, sistemi aperti senza gemelli paralleli): `docs/PRO2_CROSS_LAYER_CONTEXT_HUB_AND_ENRICHMENT.md`.
