...
const QUERIES: Array<{ id: string; query: string; aliasFor?: string }> = [
  ...
  // Verdure
  { id: "spinach_raw", query: "Spinach, raw", aliasFor: "mixed_veg" },
  { id: "tomato_raw", query: "Tomatoes, red, ripe, raw, year round average" },
  { id: "carrot_raw", query: "Carrots, raw" },
  { id: "broccoli_raw", query: "Broccoli, raw" },
  { id: "cauliflower_raw", query: "Cauliflower, raw" },
  { id: "bell_pepper_red", query: "Peppers, sweet, red, raw" },
  { id: "zucchini_raw", query: "Squash, summer, zucchini, includes skin, raw" },
  { id: "eggplant_raw", query: "Eggplant, raw" },
  { id: "lettuce_romaine", query: "Lettuce, cos or romaine, raw" },
  ...
  { id: "asparagus_raw", query: "Asparagus, raw" },
  { id: "cabbage_raw", query: "Cabbage, raw" },
  { id: "beetroot_raw", query: "Beets, raw" },
  { id: "mushrooms_raw", query: "Mushrooms, white, raw" },
  { id: "fennel_raw", query: "Fennel, bulb, raw" },
  { id: "kale_raw", query: "Kale, raw" },
  { id: "arugula_raw", query: "Arugula, raw" },
  ...
  { id: "chickpeas_cooked", query: "Chickpeas, mature seeds, cooked, boiled, without salt" },
  ...
  // Frutta
  { id: "apple_raw", query: "Apples, raw, with skin" },
  { id: "banana_raw", query: "Bananas, raw" },
  { id: "orange_raw", query: "Oranges, raw, all commercial varieties" },
  { id: "strawberries_raw", query: "Strawberries, raw" },
  { id: "blueberries_raw", query: "Blueberries, raw", aliasFor: "mixed_fruit" },
  { id: "raspberries_raw", query: "Raspberries, raw" },
  { id: "pear_raw", query: "Pears, raw" },
  ...
  { id: "kiwi_raw", query: "Kiwifruit, green, raw" },
  ...
  { id: "cheese_ricotta", query: "Cheese, ricotta, whole milk" },
  { id: "cheese_cottage", query: "Cheese, cottage, lowfat, 1% milkfat" },
  ...
  { id: "almonds_raw", query: "Nuts, almonds, raw" },
  ...
  { id: "pumpkin_seeds_raw", query: "Seeds, pumpkin and squash seed kernels, dried" },
  ...
  { id: "dark_chocolate_70", query: "Chocolate, dark, 70-85% cacao solids" },
