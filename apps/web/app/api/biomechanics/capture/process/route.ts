...
import { processBiomechanicsCaptureJob } from "@/lib/biomechanics/biomech-capture-process-pipeline";
...
export async function POST(req: NextRequest) {
  try {
    ...
    const result = await processBiomechanicsCaptureJob(db, { athleteId, jobId });
    ...
    const message = err instanceof Error ? err.message : "biomech_process_failed";
