...
/**
 * Stato collegamento WHOOP (solo maschera `external_user_id`, nessun token). Auth + accesso atleta.
 */
      ...
      return NextResponse.json(
        {
          ...
          ...(missingTable
            ? {
                hint: "Applica la migration vendor_oauth_links e verifica SUPABASE_SERVICE_ROLE_KEY.",
              }
            : {}),
        },
