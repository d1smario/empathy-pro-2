-- Pro 2 media assets catalog parity from V1.
--
-- Fonti V1:
-- - nextjs-empathy-pro/supabase/migrations/012_media_assets_catalog.sql
-- - nextjs-empathy-pro/supabase/migrations/013_media_assets_quality_ops.sql
