-- Paste in Supabase SQL Editor — Pro 2 026 core state tables.
-- Safe to rerun: CREATE IF NOT EXISTS + DROP/CREATE policies.
-- Mirrors: supabase/migrations/026_v1_remaining_core_state_tables.sql
